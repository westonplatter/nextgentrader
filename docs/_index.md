...
| [tradebot-workers.md](tradebot-workers.md)                                   | workers, jobs, heartbeat, architecture                         | Worker construction details for `worker:jobs`, heartbeat health, and operational flow                |
